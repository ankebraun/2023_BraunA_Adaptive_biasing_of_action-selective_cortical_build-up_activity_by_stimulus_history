"""
Plot best-fitting model orders for behavioral history bias
"""
import matplotlib
...
df1_neutral = pd.read_csv("Figure 1-Figure Supplement 1-Source Data 1.csv", sep="\t")
df1_repetitive = pd.read_csv("Figure 1-Figure Supplement 1-Source Data 2.csv", sep="\t")
df1_alternating = pd.read_csv(
    "Figure 1-Figure Supplement 1-Source Data 3.csv", sep="\t"
)
...
def plot_ll(df1, col, lab, ax):
    ...
    ax.plot(
        [mean_model_order, mean_model_order],
        [0, 12],
        color="gray",
        linestyle="-.",
        linewidth=1,
