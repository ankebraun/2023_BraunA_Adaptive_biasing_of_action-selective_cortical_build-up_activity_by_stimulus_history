...
def get_clusters():
    ...
    # jwg_clusters = {
    #     'JWG_aIPS': ['lh.JWDG.lr_aIPS1-lh-lh', 'rh.JWDG.lr_aIPS1-rh-rh', ],
    #     'JWG_IPS_PCeS': ['lh.JWDG.lr_IPS_PCes-lh-lh', 'rh.JWDG.lr_IPS_PCes-rh-rh', ],
    #     'JWG_M1': ['lh.JWDG.lr_M1-lh-lh', 'rh.JWDG.lr_M1-rh-rh', ],
    # }
    jwg_clusters = {
...
#        'JWG_aIPS_PCeS': ['lh.JWDG.lr_aIPS1-lh', 'rh.JWDG.lr_aIPS1-rh', 'lh.JWDG.lr_IPS_PCes-lh', 'rh.JWDG.lr_IPS_PCes-rh'],
    }
...
#areas['aIPS_PCeS'] = ['JWG_aIPS', 'JWG_IPS_PCeS']
